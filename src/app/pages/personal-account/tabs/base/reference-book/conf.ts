...
export const referenceConfig = [
    {
        typeId: '195630',
        endpoint: 'api/Entities/Organization',
        endpoints: {
            getAllItems: 'api/Entities/Organization/Filter',
            getByIdItem: 'api/Entities/Organization',
            createItem: 'api/Entities/Organization',
            updateItem: 'api/Entities/Organization',
            deleteItem: 'api/Entities/Organization',
        },
